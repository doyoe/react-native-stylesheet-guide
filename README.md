...
textShadowOffset | {width: [&lt;number&gt;](#user-content-number), height: [&lt;number&gt;](#user-content-number)} | 对应 `CSS` 中的 [text-shadow](http://css.doyoe.com/properties/text-decoration/text-shadow.htm) 属性中的阴影偏移定义
...
shadowOffset | {width: [&lt;number&gt;](#user-content-number), height: [&lt;number&gt;](#user-content-number)} | 对应 `CSS` 中的 [box-shadow](http://css.doyoe.com/properties/border/box-shadow.htm) 属性中的阴影偏移定义
